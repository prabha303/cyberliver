...
require (
	github.com/FenixAra/go-http v0.0.0-20191114034924-d3b0170aec54 // indirect
	github.com/FenixAra/go-prom v0.0.0-20190512110115-a9b8012f582f // indirect
	...
	pault.ag/go/haversine v0.0.0-20180514173713-54fbd0f97f68 // indirect
)
